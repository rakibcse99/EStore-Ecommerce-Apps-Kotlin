package com.rakibstudio.e_store.data

import com.rakibstudio.e_store.R
import com.rakibstudio.e_store.data.model.*
...
object DummyData {
    ...
    fun getReviews(): MutableList<ReviewModel> {
        ...
        reviewList.addAll(
            listOf(
                ReviewModel(
                    UserModel("123", "Rakib", "BNNHg", R.drawable.ic_account_profile),
                    "Review Body 1",
                    3f
                ),
                ReviewModel(
                ...
                ReviewModel(
                    UserModel("123", "Kobir", "Abc", R.drawable.ic_account_profile),
                    "Review Body 3",
                    5f
                ),
                ReviewModel(
                    UserModel("123", "Rimon", "Email", R.drawable.ic_account_profile),
                    "Review Body 4",
                    5f
                )
            )
    ...
    fun getUserData(): UserModel {
        val card = CardModel(1233467581234987, "Rakib Sheikh", "12 - 9", CardTypeEnum.MASTER_CARD)
        val address1 = AddressModel("Home", "Mohakhali wirless ,cha 26", true)
        val address2 = AddressModel("Work", "Mohakhali wirless ,cha 26")
        userModel = UserModel(
            "123",
            "Rakib Sheikh",
            "rakib898907@gmail.com",
